...
Процедура КнопкаВыполнитьНажатие(Кнопка)
	...
	Пока ЧтениеXML.Прочитать() Цикл                  
		...
		Если ЧтениеXML.Имя = "СписаниеСРасчетногоСчета" Тогда 
			...
			ТекПодразделениеДт = Справочники.ПодразделенияОрганизаций.НайтиПоНаименованию(ПодразделениеДт);
		...
		ИначеЕсли ЧтениеXML.Имя = "ПоступлениеНаРасчетныйСчет" Тогда 
			...
			ТекПодразделениеКт = Справочники.ПодразделенияОрганизаций.НайтиПоНаименованию(ПодразделениеКт);
