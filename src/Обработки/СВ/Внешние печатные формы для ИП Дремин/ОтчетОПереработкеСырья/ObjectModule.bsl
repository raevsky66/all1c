...
Функция ПечатьДокумента(ТабЧасть, МассивОбъектов, ОбъектыПечати)
	...
	Пока Выборка.Следующий() Цикл
		...
		ОбластьМакета.Параметры.Отпустил = "Индивидуальный предприниматель Дремин А.А.";
		ОбластьМакета.Параметры.Получил = "Управляющий-индивидуальный предприниматель Чуйков М.Г.";
		ТабличныйДокумент.Вывести(ОбластьМакета);
...
Процедура Печать(МассивОбъектовНазначения, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ОтчетОПереработкеСырьяСПодвалом") Тогда
		 УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ОтчетОПереработкеСырьяСПодвалом", "Отчет о переработке сырья с подвалом",
...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ДобавитьКоманду(ТаблицаКоманд,
		"Отчет о переработке сырья с подвалом", // Представление команды в пользовательском интерфейсе
		"ОтчетОПереработкеСырьяСПодвалом",				// Уникальный идентификатор команды
	);
